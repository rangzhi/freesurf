# ./pox.py listfilter --localnet=10.0.0.0/8 forwarding.l2_learning py
# POX> core.listfilter.add(('IPV4 172.18.0.4', 'ICMP'))
# POX> core.listfilter.rm(('IPV4 172.18.0.4', 'ICMP'))
...
class nobloom( object ):
	def __init__( self, localnet ):
		...
		log.info( "Initiated non-Bloom Filter" )
                ...
                # manually adding all the addresses
                '''i = 0
                prefix = 'IPV4 10.0.'
                prtl = 'ICMP'
                numofhosts = 3000 # hosts number < 65535
